...
// avoid polluting window
{
    ...
    function initCart() {
        ...
        productList.forEach(productEl => {
            const purchaseBtn = productEl.getElementsByTagName('button')[0]
        ...
        function purchaseItem(itemDetails) {
            return () => {
                // update cart arr
        ...
        function updateCartIcon(cartSize) {
            ...
            let notificationEl = cartChildren
                .filter(({ tagName }) => tagName !== 'IMG')[0]
